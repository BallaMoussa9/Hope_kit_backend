...
class CommercialDocumentController extends Controller
{
    ...
    public function setStatus(Request $r, CommercialDocument $document)
    {
        ...
        $allowed = $document->type === 'proforma'
            ...
            : ['draft'=>['draft','sent','accepted','cancelled'],'sent'=>['sent','accepted','rejected','cancelled'],'accepted'=>['accepted','cancelled'],'partially_paid'=>['partially_paid'],'paid'=>['paid'],'closed'=>['closed'],'cancelled'=>['cancelled']];
